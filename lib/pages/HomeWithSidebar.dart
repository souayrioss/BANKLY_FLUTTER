                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(image: AssetImage('assets/images/avatar4.png'),
                              fit: BoxFit.contain
                              )
                            ),
                          ),
                          ...
                          Column(
                            ...
                            children: [
                              Text("Oussama Souayri",style: TextStyle(fontSize: 19,fontWeight: FontWeight.w700),),
                              Text("Youssoufia | Morocco",style: TextStyle(fontSize: 13,fontWeight: FontWeight.w400,color: Colors.grey),),
                            ],
                          )
                        ],
                      ),
